...
namespace DAL.App.EF.Repositories
{
    public class OrderRepository :
        EFBaseRepository<AppDbContext, AppUser, Domain.App.Order, DAL.App.DTO.Order>,
        IOrderRepository
    {
        ...
        // }
        //
        // public virtual async Task<IEnumerable<OrderView>> GetAllForViewAsync(int minLocationsCount = 10,
        ...
        // }
        //
        // public async Task<Order> GetFirstWithAllLocationsAsync(Guid id)
        // {
        //     var domainOrder = await RepoDbSet.AsNoTracking()
        //         .FirstOrDefaultAsync(a => a.Id == id);
        //
        //     domainOrder.GpsLocations = await RepoDbContext.GpsLocations.AsNoTracking()
        //         .Where(l => l.OrderId == id)
        //         .OrderByDescending(l => l.RecordedAt)
        //         .ToListAsync();
        //
        //     return Mapper.Map(domainOrder);
        // }
        public Task<IEnumerable<Order>> GetAllAsync(Guid balanceId, Guid? userId = null, bool noTracking = true)
        {
            throw new NotImplementedException();
        }

        public Task<Order> GetFirstWithAllLocationsAsync(Guid id)
        {
            throw new NotImplementedException();
        }
    }
