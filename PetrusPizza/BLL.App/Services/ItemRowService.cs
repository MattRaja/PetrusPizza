...
{
    public class ItemRowService :
        BaseEntityService<IAppUnitOfWork, IItemRowRepository, IItemRowServiceMapper, DAL.App.DTO.ItemRow,
            ee.itcollege.mrajam.BLL.App.DTO.ItemRow>, IItemRowService
    {
        public ItemRowService(IAppUnitOfWork uow) : base(uow, uow.ItemRows, new ItemRowServiceMapper())
        {
        }


        // public virtual async Task<IEnumerable<ItemRowView>> GetAllForViewAsync(int minLocationsCount = 10, double minDuration = 60, double minDistance = 10, DateTime? fromDateTime = null, DateTime? toDateTime = null)
        // {
        //     return (await Repository.GetAllForViewAsync(minLocationsCount, minDuration, minDistance, fromDateTime, toDateTime)).Select(e => Mapper.MapItemRowView(e));
        // }
        //
        // public async Task UpdateStatisticsAsync(Guid id)
        // {
        //     // take the session, with all the locations. recalculate stats.
        //     var session = await  UOW.ItemRows.GetFirstWithAllLocationsAsync(id);
        ...
        //
        //     await UOW.ItemRows.UpdateAsync(session);
        ...
        // }
        public Task<IEnumerable<ItemRow>> GetAllAsync(Guid appUserId, Guid? userId = null, bool noTracking = true)
        {
            throw new NotImplementedException();
        }

        public Task<ItemRow> AddAndUpdateAsync(ItemRow appUser)
        {
            throw new NotImplementedException();
        }
    }
