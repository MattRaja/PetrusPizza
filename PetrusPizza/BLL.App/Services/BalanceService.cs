...
namespace BLL.App.Services
{
    public class BalanceService :
        BaseEntityService<IAppUnitOfWork, IBalanceRepository, IBalanceServiceMapper, DAL.App.DTO.Balance,
            Balance>, IBalanceService
    {
        public BalanceService(IAppUnitOfWork uow) : base(uow, uow.Balances, new BalanceServiceMapper())
        {
        }


        // public virtual async Task<IEnumerable<BalanceView>> GetAllForViewAsync(int minLocationsCount = 10, double minDuration = 60, double minDistance = 10, DateTime? fromDateTime = null, DateTime? toDateTime = null)
        // {
        //     return (await Repository.GetAllForViewAsync(minLocationsCount, minDuration, minDistance, fromDateTime, toDateTime)).Select(e => Mapper.MapBalanceView(e));
        // }
        //
        // public async Task UpdateStatisticsAsync(Guid id)
        // {
        //     // take the session, with all the locations. recalculate stats.
        //     var session = await  UOW.Balances.GetFirstWithAllLocationsAsync(id);
        ...
        //
        //     await UOW.Balances.UpdateAsync(session);
        ...
        // }
        public Task<IEnumerable<Balance>> GetAllAsync(Guid appUserId, Guid? userId = null, bool noTracking = true)
        {
            throw new NotImplementedException();
        }

        public Task<Balance> AddAndUpdateAsync(Balance appUser)
        {
            throw new NotImplementedException();
        }
    }
