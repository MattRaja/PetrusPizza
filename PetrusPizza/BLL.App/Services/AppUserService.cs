...
namespace BLL.App.Services
{
    public class AppUserService :
        BaseEntityService<IAppUnitOfWork, IAppUserRepository, IAppUserServiceMapper, DAL.App.DTO.Identity.AppUser,
            ee.itcollege.mrajam.BLL.App.DTO.Identity.AppUser>, IAppUserService
    {
        ...
        // public virtual async Task<IEnumerable<AppUserView>> GetAllForViewAsync(int minLocationsCount = 10, double minDuration = 60, double minDistance = 10, DateTime? fromDateTime = null, DateTime? toDateTime = null)
        // {
        //     return (await Repository.GetAllForViewAsync(minLocationsCount, minDuration, minDistance, fromDateTime, toDateTime)).Select(e => Mapper.MapAppUserView(e));
        // }
        //
        // public async Task UpdateStatisticsAsync(Guid id)
        // {
        //     // take the session, with all the locations. recalculate stats.
        //     var session = await  UOW.AppUsers.GetFirstWithAllLocationsAsync(id);
        ...
        //
        //     await UOW.AppUsers.UpdateAsync(session);
        ...
        public Task<AppUser> AddAndUpdateAsync(AppUser appUser)
        {
            throw new NotImplementedException();
        }
    }
