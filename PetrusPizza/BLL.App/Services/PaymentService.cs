...
namespace BLL.App.Services
{
    public class PaymentService :
        BaseEntityService<IAppUnitOfWork, IPaymentRepository, IPaymentServiceMapper, DAL.App.DTO.Payment,
            Payment>, IPaymentService
    {
        ...
        // public virtual async Task<IEnumerable<PaymentView>> GetAllForViewAsync(int minLocationsCount = 10, double minDuration = 60, double minDistance = 10, DateTime? fromDateTime = null, DateTime? toDateTime = null)
        // {
        //     return (await Repository.GetAllForViewAsync(minLocationsCount, minDuration, minDistance, fromDateTime, toDateTime)).Select(e => Mapper.MapPaymentView(e));
        // }
        //
        // public async Task UpdateStatisticsAsync(Guid id)
        // {
        //     // take the session, with all the locations. recalculate stats.
        //     var session = await  UOW.Payments.GetFirstWithAllLocationsAsync(id);
        ...
        //
        //     await UOW.Payments.UpdateAsync(session);
        ...
        // }
        public Task<IEnumerable<Payment>> GetAllAsync(Guid appUserId, Guid? userId = null, bool noTracking = true)
        {
            throw new NotImplementedException();
        }

        public Task<Payment> AddAndUpdateAsync(Payment appUser)
        {
            throw new NotImplementedException();
        }
    }
