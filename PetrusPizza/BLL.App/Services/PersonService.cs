...
namespace BLL.App.Services
{
            ...
            Person>, IPersonService
    {
        ...
        // public virtual async Task<IEnumerable<PersonView>> GetAllForViewAsync(int minLocationsCount = 10, double minDuration = 60, double minDistance = 10, DateTime? fromDateTime = null, DateTime? toDateTime = null)
        // {
        //     return (await Repository.GetAllForViewAsync(minLocationsCount, minDuration, minDistance, fromDateTime, toDateTime)).Select(e => Mapper.MapPersonView(e));
        // }
        //
        // public async Task UpdateStatisticsAsync(Guid id)
        // {
        //     // take the session, with all the locations. recalculate stats.
        //     var session = await  UOW.Persons.GetFirstWithAllLocationsAsync(id);
        ...
        //
        //     await UOW.Persons.UpdateAsync(session);
        ...
        // }
        public Task<IEnumerable<Person>> GetAllAsync(Guid appUserId, Guid? userId = null, bool noTracking = true)
        {
            throw new NotImplementedException();
        }

        public Task<Person> AddAndUpdateAsync(Person appUser)
        {
            throw new NotImplementedException();
        }
    }
