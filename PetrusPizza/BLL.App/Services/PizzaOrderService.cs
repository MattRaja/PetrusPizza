...
namespace BLL.App.Services
{
    public class PizzaOrderService :
        BaseEntityService<IAppUnitOfWork, IPizzaOrderRepository, IPizzaOrderServiceMapper, DAL.App.DTO.PizzaOrder,
            PizzaOrder>, IPizzaOrderService
    {
        public PizzaOrderService(IAppUnitOfWork uow) : base(uow, uow.PizzaOrders, new PizzaOrderServiceMapper())
        {
        }


        // public virtual async Task<IEnumerable<PizzaOrderView>> GetAllForViewAsync(int minLocationsCount = 10, double minDuration = 60, double minDistance = 10, DateTime? fromDateTime = null, DateTime? toDateTime = null)
        // {
        //     return (await Repository.GetAllForViewAsync(minLocationsCount, minDuration, minDistance, fromDateTime, toDateTime)).Select(e => Mapper.MapPizzaOrderView(e));
        // }
        //
        // public async Task UpdateStatisticsAsync(Guid id)
        // {
        //     // take the session, with all the locations. recalculate stats.
        //     var session = await  UOW.PizzaOrders.GetFirstWithAllLocationsAsync(id);
        ...
        //
        //     await UOW.PizzaOrders.UpdateAsync(session);
        ...
        // }
        public Task<IEnumerable<PizzaOrder>> GetAllAsync(Guid appUserId, Guid? userId = null, bool noTracking = true)
        {
            throw new NotImplementedException();
        }

        public Task<PizzaOrder> AddAndUpdateAsync(PizzaOrder appUser)
        {
            throw new NotImplementedException();
        }
    }
